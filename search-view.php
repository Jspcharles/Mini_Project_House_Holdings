		...
		<div class="row" >
			...
			<div class="col-lg-2 col-md-2 col-sm-3 col-xs-10 box2">
				<a href="#" d="0124" class="colorofbox" title="Prime Life Kadawatha">
					...
					<img style='height:100px;width:100%;'src="admin/images/pics/<?php echo  $row['image_name'];?>" width="100%" /><br>
			...
			<div class="col-lg-2 col-md-2 col-sm-3 col-xs-10 box2">
				<a href="#" d="0124" class="colorofbox" title="Prime Life Kadawatha">
					...
					<img style='height:100px;width:100%;'src="admin/images/pics/<?php echo  $cat_row['image_name'];?>" width="100%" /><br>
